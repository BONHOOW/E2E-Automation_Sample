...
export class Checkout {
    ...
    async clickGuestSignInButton() {
        try {
            const button = this.page.locator('button[data-an-la="samsung account"]')
     ...
     * Playwright implementation of Katalon Studio's findDisplayedElement and WebUI.back() functionality
     */
     ...
     * Playwright implementation of Katalon Studio's findDisplayedElement and KeywordUtil.markError functionality
     */
     ...
     * Playwright implementation of Katalon Studio's continueToPayment function
     */
    ...
    /**
     * Empties the cart
     * Playwright implementation of Katalon Studio's emptyCart function (API method)
     */
    async emptyCart() {
        try {
            while (true) {
