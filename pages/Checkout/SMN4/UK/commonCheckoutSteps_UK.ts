...
/**
 * Completes the Contact Details section
 */
...
/**
 * Completes the Delivery Address section
 */
...
/**
 * Completes the entire checkout form (Contact Details + Delivery Address + Billing Address + next step)
 */
...
/**
 * Handles checkout logic for Prod_Checkout_01 test
 * Completes basic checkout form and proceeds to validation step
 */
...
/**
 * Handles checkout logic for Prod_Checkout_02 test
 * Tests checkout flow with address editing functionality and form validation
 */
...
/**
 * Handles checkout logic for Prod_Checkout_03 test
 * Verifies saved addresses after adding them and proceeds to payment
 */
...
/**
 * Handles checkout logic for Prod_Checkout_04 test
 * Completes checkout form and proceeds to payment step with input validation
 */
...
/**
 * Handles checkout logic for Prod_Checkout_05 test
 * 
 */
...
/**
 * Handles checkout logic for Prod_Checkout_05_1 test
 * Tests form visibility validation after returning to edit mode
 */
...
/**
 * Handles checkout logic for Prod_Checkout_06 test
 * Completes checkout form with delivery option selection and proceeds to payment
 */
...
/**
 * Handles checkout logic for Prod_Checkout_07 test
 * Completes checkout form with store pickup option selection and proceeds to payment
 */
...
/**
 * Handles checkout logic for Prod_Checkout_08 test
 * Completes checkout form with collection/recycling service selection and proceeds to payment
 */
...
/**
 * Handles checkout logic for Prod_Checkout_09 test
 * Completes VD product checkout form and proceeds to payment
 */
...
/**
 * Handles checkout logic for Prod_Checkout_10 test
 * Completes HA product checkout form with installation service selection and proceeds to payment
 */
...
/**
 * Handles checkout logic for prod_Payment_01 test
 * Completes basic checkout form and proceeds to payment
 */
